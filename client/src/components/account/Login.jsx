...
const Login = ({ isUserAuthenticated }) => {
    ...
    const onValueChange = (e) => {
        setLogin({ ...login, [e.target.name]: e.target.value || '' }); // Fix for undefined value
    };

    const onInputChange = (e) => {
        setSignup({ ...signup, [e.target.name]: e.target.value || '' }); // Fix for undefined value
    };
                ...
                <Image src={imageURL} alt="blog" />
                {
                    account === 'login' ?
                        ...
                        <Wrapper>
                            ...
                            <TextField variant="standard" type="password" value={signup.password} onChange={(e) => onInputChange(e)} name='password' label='Enter Password' />
